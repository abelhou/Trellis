...
|-------|-------------------|-------------------|
| `frontend-design` | `cli/frontend` | `examples/skills/frontend-design/` |
| `mcp-builder` | `cli/backend` | `examples/skills/mcp-builder/` |
| `webapp-testing` | `cli/frontend` | `examples/skills/webapp-testing/` |
